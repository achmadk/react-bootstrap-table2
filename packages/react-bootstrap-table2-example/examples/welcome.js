...
import logoColorSquare from '../public/images/logo-color-square.svg';
      ...
      <div>
        <div className="welcome">
          <div className="welcome-title">
            <span className="welcome-title-logo">
              <img src={ logoColorSquare } alt={ `${PROJECT_NAME}-logo` } />
            </span>
            <h1>
              {PROJECT_NAME}
            </h1>
        ...
        <a href={ `https://github.com/react-bootstrap-table/${PROJECT_NAME}` } className="github-corner" aria-label="View source on Github">
          <svg
            ...
            viewBox="0 0 250 250"
            style={ {
              fill: '#0058B7', color: '#fff', position: 'absolute', top: '0', border: '0', right: '0'
            } }
            aria-hidden="true"
          >
