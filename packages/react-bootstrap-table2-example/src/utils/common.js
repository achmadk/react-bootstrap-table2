...
export const productsQualityGenerator = (quantity = 5, factor = 0) => Array.from({ length: quantity }, (value, index) => ({
  id: index + factor,
...
export const jobsGenerator = (quantity = 5) => Array.from({ length: quantity }, (value, index) => ({
  id: index,
  name: `Job name ${index}`,
...
export const jobsGenerator1 = (quantity = 5) => Array.from({ length: quantity }, (value, index) => ({
  id: index,
  name: `Job name ${index}`,
...
export const todosGenerator = (quantity = 5) => Array.from({ length: quantity }, (value, index) => ({
  id: index,
...
export const stockGenerator = (quantity = 5) => Array.from({ length: quantity }, (value, index) => ({
  id: index,
